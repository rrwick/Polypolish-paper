...
results <- read_excel("../tables/Table_S2_real_read_results.xlsx", sheet = "Results", col_names = TRUE)
...
ggplot(results, aes(x=polishing, y=total_distance, colour=polishing, shape=set)) +
